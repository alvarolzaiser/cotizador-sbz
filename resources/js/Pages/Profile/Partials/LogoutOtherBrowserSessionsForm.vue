...
<template>
    <ActionSection>
        ...
        <template #description>
            Gestionar y cerrar sesión de tus sesion activas en otros navegadores y dispositivos.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Si es necesario, puedes cerrar sesión en todas tus otras sesiones de navegador en todos tus dispositivos. Algunas de tus sesiones recientes están listadas a continuación; sin embargo, esta lista puede no ser exhaustiva. Si crees que tu cuenta ha sido comprometida, también deberías actualizar tu contraseña.
            </div>
            ...
            <div class="flex items-center mt-5">
                <PrimaryButton @click="confirmLogout">
                    Cerrar Sesión de Otros Navegadores
                </PrimaryButton>
